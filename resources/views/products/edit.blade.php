    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('products.update', $dataEditproduct->product_id) }}" method="POST">
                        @csrf
                        @method('PUT') <!-- This ensures the form uses PUT method for updating -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="product_name" name="product_name" class="form-control"
                                       value="{{ old('product_name', $dataEditproduct->product_name) }}" required />
                                ...
                                <select name="category_id" id="category_id" class="form-select" required>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->category_id }}" 
                                            {{ old('category_id', $dataEditproduct->category_id) == $category->category_id ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="product_description" name="product_description" class="form-control">
                                    {{ old('product_description', $dataEditproduct->product_description) }}
                                </textarea>
